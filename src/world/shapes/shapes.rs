...
mod json_models {
    use crate::{
        algebra::transform::InversableTransform,
        world::{json_models::ShapeJson, material::MaterialPtr},
    };
    ...
    impl ShapeJson for Rectangle {
        fn make_shape(&self, materials: &HashMap<String, MaterialPtr>) -> Box<dyn super::Shape> {
